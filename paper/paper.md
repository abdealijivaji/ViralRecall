...
![Process Runtime in seconds, Memory Utilization, and CPU Utilization comparison of Viralrecall v2.0 vs v3.0 (Current version).](./speed_mem_cpu_table.png){ width = "20%" }
